...
Then if the canonical form equation \eqref{eq:el_sys_can} admits a periodic solution \(\tilde{X}\) with period \(T\), we obtain a \(2\pi\)-periodic solution to the Euler-Lagrange equation \eqref{eq:el} with \(\lambda = \tfrac{T^2}{4\pi^2}\) and any \(\Lambdaa \ne (0, 0)\) by letting
\[
